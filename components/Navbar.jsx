...
export default function NavBar() {
  ...
  const [selectedTabText, setSelectedTabText] = useState(null);
  ...
  return (
    <div className={classes.root}>
      ...
      >
        ...
        <Divider />
        <List>
          {["Pokedex", "Inventory", "Analytics"].map((text, index) => (
            <ListItem
              button
              key={text}
              onClick={() => setSelectedTabText(text)}
            >
              <ListItemIcon>
                <InboxIcon className={navbarStyles.drawerIcons} />
              </ListItemIcon>
              <ListItemText
